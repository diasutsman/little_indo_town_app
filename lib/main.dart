...
import 'package:little_indo_town_app/components/cubit/app_redirect_to_route_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => AppRedirectToRouteCubit(),
        ),
      ],
      child: BlocBuilder<AppRedirectToRouteCubit, AppRedirectToRouteState>(
        builder: (context, state) {
          return state.onLoadingBoarding
              ? const SizedBox()
              : MaterialApp(
                  ...
                  initialRoute:
                      state.showOnboarding ? Routes.onboarding : Routes.main,
                );
        },
      ),
    );
